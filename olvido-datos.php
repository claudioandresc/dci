...
$buscar=mysql_query("SELECT * FROM miembros WHERE email='$Email'");
...
$to = $d['email'];
$asunto = "Su Clave de Ingreso - Destiny Church International";
...
$msg.= "<tr><td bgcolor='#ffffff' style='padding:0px 40px; color:#666666;'><b style='color:#a51d8c;'>Bendiciones ".$d['nombre'].".</b><br />";
$msg.= "Has solicitado recordar los datos de acceso a tu cuenta en <b>Destiny Church International</b>:<br /><br />";
$msg.= "<b>- EMAIL:</b>  ".$d['email']."<br />";
$msg.= "<b>- CLAVE:</b>  ".$d['clave']."<br /><br />";
$msg.= "Te recomendamos tenerlos a la mano para cuando nos visites.<br />La Paz de Cristo te acompa&ntilde;e.<br /><br />";
...
if($_GET['e']==1){
  $result = mysql_query("SELECT * FROM miembros WHERE idUser='mysql_real_escape_string($_GET[id])'");
...
<form id="registro" name="registro" method="post" action="?act=1">
  <table width="400" border="0" align="center" cellpadding="2" cellspacing="0">
    <tr>
      <td><h1>&iquest;Olvido sus datos?</h1></td>
    </tr>
    <tr>
      <td height="1"></td>
    </tr>
